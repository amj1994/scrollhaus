...
## Style
A professional enterprise-grade interface with clean lines, precise spacing, and a composed blue-tone palette inspired by Ant Design for clarity and efficient interaction
...
- **Font:** 14px, body color, 1.57 line-height
...
| Size | Font size | Horizontal padding | Vertical padding |
|---|---|---|---|
| Extra small | 12px | 8px | 2px |
| Small | 14px | 8px | 4px |
| Base (default) | 14px | 16px | 5px |
| Large | 16px | 16px | 7px |
| Extra large | 16px | 20px | 8px |
...
- Desktop: 16px, medium weight, heading color
...
- Body copy: 14px, 1.57 line-height
...
- Padding: 11px horizontal, 4px vertical unless overridden for icon variants
...
- Default to clean, flat solid fills with subtle elevation through shadows.
- Apply contextual treatments — subtle gradients, light background tints — that align with the professional enterprise aesthetic.
...
| shadow-sm | `0 2px 8px 0 rgba(0, 0, 0, 0.08), 0 1px 4px -1px rgba(0, 0, 0, 0.08)` |
...
| shadow-xl | `0 12px 24px -4px rgba(0, 0, 0, 0.12), 0 8px 16px -8px rgba(0, 0, 0, 0.08)` |
