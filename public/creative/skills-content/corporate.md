...
## Style
A sharp, monochromatic corporate-tech interface built on black (#0A0A0A) and white with clean typography, zero border-radius, and bold section contrast — designed to convey authority, precision, and modern infrastructure
...
- Borders use pure gray tones (no blue-tinted grays) to match the monochromatic palette
...
- Body copy: 16px, 1.625 line-height, Poppins font
...
- **Font:** Poppins, sans-serif — configured at app level via Google Fonts, never override
