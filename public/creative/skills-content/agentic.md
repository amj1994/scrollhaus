...
## Style
A sleek, agentic AI-first interface with deep dark surfaces, vibrant magenta-to-purple gradients, crisp typography, and generous whitespace — inspired by modern SaaS platforms like Zixflow
...
- **Transition:** background 200ms, color 150ms, box-shadow 200ms
...
### Brand
- **Background:** `linear-gradient(135deg, #C8399C 0%, #7C3AED 100%)` — gradient from brand magenta to vibrant purple
- **Border:** transparent
- **Text:** white
- **Hover:** `linear-gradient(135deg, #A52D80 0%, #6D28D9 100%)` — darker gradient shift
...
- Apply contextual treatments — gradient meshes with brand magenta-to-purple tones, subtle noise textures, geometric dot/grid patterns, layered glass-like transparencies, soft glow effects, decorative borders, grain overlays — that align with the agentic AI-first aesthetic.
- Consider subtle radial gradient glows (using brand tones at low opacity) behind hero sections and key feature areas for depth.
...
| shadow-xl | `0 20px 28px -6px rgb(0 0 0 / 0.1), 0 8px 12px -6px rgb(0 0 0 / 0.04)` |
...
| First item | rounded start (14px) |
| Last item | rounded end (14px) |
