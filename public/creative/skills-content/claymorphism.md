...
- [sections.md](sections.md) — section backgrounds (uniform color)
...
### Separated Cards
Each item is independent — has its own 1px border, 36px radius, and shadow-md. 8px bottom margin between items. No shared outer border.
...
- **Radius:** 999px (default) — pill-shaped claymorphism buttons
- **Border:** 1px solid
- **Shadow:** shadow-sm
...
| Mobile | 32px |
| Tablet (≥768px) | 48px |
| Desktop (≥1024px) | 64px or 112px for hero/feature sections |
...
- **Font:** Poppins, sans-serif — configured at app level, never override
- **Headings:** semibold weight (600), heading text color — **except `h1` which uses extra-bold weight (800)**
