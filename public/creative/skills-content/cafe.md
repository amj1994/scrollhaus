...
### Components
- [buttons.md](buttons.md) — button variants, sizes, states, shadow effect
...
- **Border:** 1px solid
- **Shadow:** shadow-xs
- **Raised shadow effect:** Every button except ghost and disabled gets a combined box-shadow that layers the base shadow with a subtle bottom-edge raised effect:
  - `box-shadow: var(--btn-ring-offset-shadow, 0 0 #0000), var(--btn-ring-shadow, 0 0 #0000), var(--btn-shadow)` where `--btn-shadow` is `0 3px 0 0 #00000026`
...
### Ghost (NO shadow, NO raised effect)
...
### Disabled (NO shadow, NO raised effect)
- **Background:** disabled token
- **Border:** border-default-medium
- **Text:** fg-disabled color
- **Cursor:** not-allowed
- **No hover, no focus, no shadow, no raised effect**
