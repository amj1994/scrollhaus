...
## Style
A bold, developer-oriented interface with sharp geometric containers, pill-shaped interactive elements, monospace typography, strong border lines, and an expressive warm-to-dark color palette anchored by vivid orange accents
...
- **Rounded square shape:** 0px radius (sharp corners)
...
- Borders are the primary separation mechanism — prefer borders over shadows
...
- Section dividers span the full viewport width as horizontal rules
...
| Cards / containers | 1px, strong visible borders for sharp-edged containers |
...
- **Radius:** 999px (default) — all buttons are pill-shaped
- **Border:** 1px solid
- **Shadow:** shadow-xs
...
- **Radius:** 0px (base) — all cards have sharp corners
- **Shadow:** shadow-xs
...
- Radius: 999px (default) — pill-shaped items
...
- Rounded square: 0px radius (sharp corners for all sizes)
...
- **Radius:** 999px (default) — all inputs are pill-shaped
...
- First item: 999px radius on inline-start side — pill-shaped ends
- Last item: 999px radius on inline-end side — pill-shaped ends
...
- First item: pill-shaped start, Last item: pill-shaped end
...
- Padding: 8px horizontal, 8px vertical
- Text: heading color
- Radius: 999px (default) — pill-shaped nav items
- Hover: neutral-secondary-medium background
- Transition: colors
...
- Padding: 16px
- Top margin: 24px
- Radius: 0px (base) — sharp corners for card-like elements
- Background: brand-softer
...
- Radius: 999px (default) — pill-shaped
- Font weight: medium
...
| First item | 0px radius (sharp) |
| Last item | 0px radius (sharp) |
