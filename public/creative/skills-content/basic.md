...
## Style
A refined editorial publication interface with crisp white backgrounds, bold Geist typography, and a magazine-style layout designed for articles, news, and content discovery
...
- **Wrapper:** full width, 1px border (border-default color), 2px radius — clips first/last item corners
...
### Separated Cards
Each item is independent — has its own 1px border, 2px radius, and shadow-xs. 8px bottom margin between items. No shared outer border.
...
| Cards / containers | none (transparent) for dark cards; 1px subtle for light containers |
...
- **Background:** brand token (ALL active buttons must use the brand color)
- **Border:** transparent
- **Text:** white
...
| Token | Light | Dark |
|---|---|---|
| brand-softer | #EDF1FC | #0E1A38 |
| brand-soft | #C9D5F6 | #1A2D6B |
| brand | #3B60E4 | #5B7CE8 |
| brand-medium | #A8BBF1 | #1A2D6B |
| brand-strong | #2E4DB6 | #3B60E4 |
...
| Token | Light | Dark |
|---|---|---|
| fg-brand-subtle | #A8BBF1 | #1A2D6B |
| fg-brand | #3B60E4 | #7B9AEF |
| fg-brand-strong | #2E4DB6 | #A8BBF1 |
...
| border-brand-subtle | #A8BBF1 | #1A2D6B |
| border-brand-light | #3B60E4 | #3B60E4 |
| border-brand | #3B60E4 | #7B9AEF |
| border-dark-subtle | #0A1829 | #1C2E45 |
| border-purple | #A855F7 | #A855F7 |
| border-orange | #FB923C | #FB923C |

## Semantic Usage Rules

- Page/section backgrounds: neutral-primary-soft (white) for all sections — no alternating backgrounds
...
- A white background (neutral-primary-soft for all sections — no alternating)
...
- Default to clean, white backgrounds with minimal ornamentation for an editorial feel.
- Use whitespace and typography hierarchy as the primary visual structure rather than decorative treatments.
- Every visual element must serve content — photography, article cards, and typography are the main design vehicles. Avoid heavy gradients, textures, or ornamental overlays.
...
- Content: neutral-primary background, 2px radius, shadow-xl
...
- 2px is the default radius across the product
